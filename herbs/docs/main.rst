...
Каждая запись таблицы видов имеет дополнительный статус -- "From plantlist", "Approved" и "Recently added".
