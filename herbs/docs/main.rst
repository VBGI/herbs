...
Тем не менее, некоторые поля, а именно `Страна`_, `Регион`_, `Район`_, `Место сбора`_, `Высота`_, `Примечание`_, `Дополнительно`_,
...
поле `Регион`_ может быть заполнено следующим образом: "Дальний Восток России|Russian Far East" (*кавычки в форме администрования не ставятся*). 
...
- система считает русскоязычной ту подстроку относительно символа "|", в которой больше встретилось символов кириллических символов.
