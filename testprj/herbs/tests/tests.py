...
class InitialRendereTest(TestCase):
    urls = 'tests.urls'
    def setUp(self):
    ...
    def test_page_returned(self):
        ...
        self.assertIn('18827377182fndm', content)
...
# 
# 
# @override_settings(CMSNVD3_D3JS_SOURCE='local', CMSNVD3_JS_SOURCE='local',
#                    CMSNVD3_CSS='local', ROOT_URLCONF='tests.urls')
...
#         self.client = Client()
# 
#     def test_Sekizai_NotCompress(self):
#         try:
#             from compressor.exceptions import UncompressableFileError
#         except ImportError:
#             UncompressableFileError = None
#             self.assertTrue(True)
#         if not UncompressableFileError:
#             self.assertRaises(UncompressableFileError, self.client.get('/'))
# 
# 
# @override_settings(ROOT_URLCONF='tests.urls', COMPRESS_ENABLED=True,
