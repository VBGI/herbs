...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'herbs_genus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('family', self.gf('django.db.models.fields.related.ForeignKey')(related_name='genus', null=True, to=orm['herbs.Family'])),
        ))
        ...
        db.create_table(u'herbs_species', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('genus', self.gf('django.db.models.fields.related.ForeignKey')(related_name='species', to=orm['herbs.Genus'])),
        ))
        ...
        db.create_table(u'herbs_herbitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('family', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['herbs.Family'], null=True)),
            ('genus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['herbs.Genus'], null=True)),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['herbs.Species'], null=True)),
